...
{
    public static CameraScale Instance;

    [SerializeField] protected int targetWidth = 486;
    [SerializeField] protected int targetHeight = 1080;

    [SerializeField] protected int dynamicMaxWidth = 648;
    ...
    public void Update()
    {
        if (Screen.width != lastWidth || Screen.height != lastHeight)
        {
            ...
            {
                GameManager.Instance.CalculateCameraBounds();
            }
